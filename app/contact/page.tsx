              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                {socialLinks.map((link) => (
                  <a
                    ...
                    className={`group flex flex-col items-center justify-center p-6 bg-background border border-border rounded-xl transition-all duration-300 ${link.color} text-foreground hover:border-accent/40 hover:bg-accent/5`}
                  >
                    {link.icon}
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input
                      ...
                      required
                      className="w-full px-4 py-3 bg-background border border-border rounded-lg focus:outline-none focus:border-accent focus:ring-1 focus:ring-accent transition-colors"
                ...
                <div>
                  ...
                  <textarea
                    ...
                    required
                    rows={6}
                    className="w-full px-4 py-3 bg-background border border-border rounded-lg focus:outline-none focus:border-accent focus:ring-1 focus:ring-accent transition-colors resize-none"
                ...
                <button
                  ...
                  className="w-full px-6 py-3 bg-foreground text-background rounded-lg hover:opacity-85 transition-opacity font-semibold disabled:opacity-50 flex items-center justify-center gap-2 duration-300"
                >
